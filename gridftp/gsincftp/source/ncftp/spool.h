...
int CanSpool(void);
int HaveSpool(void);
int SpoolX(const char *const, const char *const, const char *const, const char *const, const char *const, const char *const, const char *const, const unsigned int, const char *const, const char *const, int, int, int, int, time_t);
