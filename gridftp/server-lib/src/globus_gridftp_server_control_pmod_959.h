...
typedef struct globus_l_gsc_959_handle_s *  globus_gsc_pmod_959_handle_t;
typedef struct globus_l_gsc_959_read_ent_s * globus_gsc_pmod_959_op_t;
 ...
 */
typedef void
(*globus_gsc_pmod_959_command_func_t)(
    globus_gsc_pmod_959_op_t                op,
    globus_gridftp_server_control_t         gsc_server,
