    ...
    int                                 access_type)
{
    ...
    {   
        ...
        else if(alias_ent->realpath && ret_path)
        {
    ...
    globus_l_gfs_data_session_t *           session_handle)
{
    ...
    {   
        ...
        if(resort)
        {
            globus_l_gfs_path_alias_list = globus_list_sort_destructive(
                globus_l_gfs_path_alias_list, globus_list_cmp_alias_ent, NULL);
        }
    }
}
