    ...
    void *                              user_arg)
{
    ...
    result = dsi->stat_func(op, stat_state, NULL);
    if(result != GLOBUS_SUCCESS)
    {
    ...
    int                                 stat_count)
{
    ...
    else
    {
        ...
        reply->id = op->id;
        reply->result = result;
        reply->info.stat.stat_info = stat_copy;
