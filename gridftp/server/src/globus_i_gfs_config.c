...
/* internal use */
 ...
 {"netlogger", "netlogger", NULL, "use-netlogger", "use-netlogger", GLOBUS_L_GFS_CONFIG_STRING, 0, NULL,
    "user netlogger to open this file.  EXPERIMENTAL.", NULL, NULL,GLOBUS_FALSE, NULL},
 ...
 {"stack", NULL, NULL, NULL, NULL, GLOBUS_L_GFS_CONFIG_VOID, 0, NULL,
   NULL, NULL, NULL,GLOBUS_FALSE, NULL},
...
globus_l_gfs_config_misc()
{
    ...
    result = globus_i_gfs_config_stack(value, "stack");
    if(result != GLOBUS_SUCCESS)
    {
        goto error_exit;
    }
