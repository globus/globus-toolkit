    ...
    const globus_fifo_t *                           fifo)
{
    ...
    return globus_list_size (s_fifo->head);
}
    ...
    void *                                          datum)
{
    ...
    if (fifo==GLOBUS_NULL) return -1;
    s_fifo = *fifo;
    if(s_fifo==GLOBUS_NULL) return -1;
    ...
    const globus_fifo_t *                                 fifo)
{
    ...
    if (fifo == GLOBUS_NULL) return NULL;
    s_fifo = *fifo;
    if(s_fifo==GLOBUS_NULL) return NULL;
    ...
    globus_fifo_t *                                 fifo)
{
    ...
    if(globus_list_empty(s_fifo->head)) return GLOBUS_NULL;
