...
This file has been tweaked to run under windows - don't try to use
this for any flavor of unix. Go back to www.gnu.org and get the
libltdl module there.

R. Gaffaney - MCS/ANL - 11/07/03
*******************************************************************
*/
