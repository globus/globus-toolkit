...
=head1 Tests for the globus common condition timdewait code

Tests to exercise the condition timedwait functionality of the globus
common library.
...
my $test_prog = 'globus_common_timedwait_test';
...
{
    $valgrind = "valgrind --log-file=VALGRIND-globus-common-timedwait-test.log";
