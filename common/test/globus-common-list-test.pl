...
=head1 Tests for the globus common list code

Tests to exercise the list functionality of the globus
common library.
...
my $test_prog = 'globus_common_list_test';
...
{
    $valgrind = "valgrind --log-file=VALGRIND-globus-common-list-test.log";
