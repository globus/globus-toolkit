...
=head1 Tests for the globus common module (de)activation code

Tests to exercise the module (de)activation functionality of the globus
common library.
...
my $test_prog = './globus_common_module_test';
...
{
    $valgrind = "valgrind --log-file=VALGRIND-globus-common-module-test.log";
