...
=head1 Tests for the globus common polling/callback code

Tests to exercise the polling callback functionality of the globus
common library.
...
{
    $valgrind = "valgrind --log-file=VALGRIND-globus-common-poll-test.log";
