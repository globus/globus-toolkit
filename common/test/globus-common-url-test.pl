...
=head1 Tests for the globus common URL parsing code

Tests to exercise the URL parsing functionality of the globus
common library.
...
{
    $valgrind = "valgrind --log-file=VALGRIND-globus-common-url-test.log";
