...
=head1 Tests for the globus common memory management code

Tests to exercise the memory management functionality of the globus
common library.
...
my $test_prog = 'globus_common_mem_test';
...
{
    $valgrind = "valgrind --log-file=VALGRIND-globus-common-mem-test.log";
