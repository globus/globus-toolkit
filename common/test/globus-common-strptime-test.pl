...
=head1 Tests for the globus common date string parsing code

Tests to exercise the date strings parsing and validating functionality of the 
globus common library.
...
my $test_prog = 'globus_common_strptime_test';
...
{
    $valgrind = "valgrind --log-file=VALGRIND-globus-common-strptime-test.log";
