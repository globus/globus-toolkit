...
=head1 Tests for the globus common env setting code

Tests to exercise the env setting functionality of the globus
common library.
...
my $test_prog = 'globus_common_libcsetenv_test';
...
{
    $valgrind = "valgrind --log-file=VALGRIND-globus-common-libcsetenv-test.log";
