...
=head1 Tests for the globus common FIFO code

Tests to exercise the FIFO functionality of the globus
common library.
...
my $test_prog = 'globus_common_fifo_test';
...
sub basic_func
{
   ...
   $rc = system("$valgrind $test_prog 5 1>$test_prog.log.stdout 2>$test_prog.log.stderr") / 256;
