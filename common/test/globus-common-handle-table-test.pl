...
=head1 Tests for the globus common table handling code

Tests to exercise the table handling functionality of the globus
common library.
...
{
    $valgrind = "valgrind --log-file=VALGRIND-globus-common-handle-test.log";
