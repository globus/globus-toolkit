...
TARFILES="gsi_openssh-3.9-src.tar.gz gsi_openssh_setup-3.9-src.tar.gz myproxy-3.7.tar.gz"
...
PACKAGES=globus_rendezvous,globus_database_psqlodbc,globus_xio_udt_ref_driver,globus_xio_skeleton_driver
