 ...
 * <p>
 * Objects which provide a persistent store for recoverability data can
 * implement this interface to receive periodic updates of the timestamp which a
 * Job State Monitor would use if it were to be restarted after being shut down
...
public interface JobStateRecoveryListener {
     ...
     */
    public void updateJobMonitorRecoveryTimeStamp(
