...
echo .
xcopy /E /Q /Y  %SSLLocation%\inc32\openssl\* %GlobusLocation%\include\openssl\
...
echo .
WinCVSBuild.pl %GlobusLocation% win32dbgmddthr %WinGlobusVersion%
call WinCVSBuildLibs-win32dbgmddthr
call WinCVSBuildExes-win32dbgmddthr
