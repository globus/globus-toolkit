...
public interface VomsConstants {
    ...
    public static final String VOMS_TRUST_STORE_DIR_PROP = "vomsTrustStore";
    public static final String VALIDATE = "vomsValidate";
    public static final String REFRESH_TIME_PROP = "vomsRefreshTime";
    public static final String CA_TRUST_STORE_DIR_PROP = "caTrustStore";
    ...
    public static final String[] ALL_CONFIG_KEYS =
            { VOMS_TRUST_STORE_DIR_PROP, VALIDATE, REFRESH_TIME_PROP,
              CA_TRUST_STORE_DIR_PROP, ATTR_SECURITY_CONFIG_FILE,
              ATTR_MAP_CONFIG_FILE, VOMS_PDP_POLICY, VOMS_PDP_AND_LOGIC,
              DEFAULT_GRIDMAP, CONSULT_GRIDMAP_KEY};
}
