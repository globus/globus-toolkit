...
public class GRAMFreqDist extends SlotLogHelper {
    ...
    public static void main(String[] args) throws Exception {
        String USAGE = "Usage: java GRAMFreqDist [options] <date (YYYY-MM-DD)> Enter -help for a list of options\n";
        ...
        GRAMFreqDist GRAMfDist = new GRAMFreqDist();
        ...
        System.out.println("<combined-gramfreqdist-report>");
        ...
        while(key.hasNext() && value.hasNext())
        {
            ...
            GRAMfDist.computeAvgTimeDiff(fDist, ipAddr);
        }

        GRAMfDist.output(System.out);
