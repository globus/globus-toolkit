...
public class RFTFreqDist extends SlotLogHelper {
    ...
    public static void main(String[] args) throws Exception {
        String USAGE = "Usage: java RFTFreqDist [options] <date (YYYY-MM-DD)> Enter -help for a list of options\n";
        ...
        RFTFreqDist RFTfDist = new RFTFreqDist();
        ...
        System.out.println("<combined-rftfreqdist-report>");
        ...
        while(key.hasNext() && value.hasNext())
        {
            ...
            RFTfDist.computeAvgTimeDiff(fDist, ipAddr);
        }

        RFTfDist.output(System.out);
