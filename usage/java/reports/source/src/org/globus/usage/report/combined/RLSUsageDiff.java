...
public class RLSUsageDiff extends SlotWeekHelper {
...
/*         System.out.println("<timediff ip=\"" + ipAddr + " diff=\"" + ((curDiff / 1000) / SEC_PER_WEEK) + " weeks\"/>"); */
    ...
    public static void main(String[] args) throws Exception {
        String USAGE = "Usage: java RLSUsageDiff [options] <date (YYYY-MM-DD)> Enter -help for a list of options\n";
        ...
        RLSUsageDiff fDistGraph = new RLSUsageDiff();
        ...
        System.out.println("<combined-rlsusagediff-report>");
