...
public class GFTPUsageDiff extends SlotWeekHelper {
...
/*         System.out.println("<timediff ip=\"" + ipAddr + " diff=\"" + ((curDiff / 1000) / SEC_PER_WEEK) + " weeks\"/>"); */
    ...
    public static void main(String[] args) throws Exception {
        String USAGE = "Usage: java GFTPUsageDiff [options] <date (YYYY-MM-DD)> Enter -help for a list of options\n";
...
/*         } */
        ...
        GFTPUsageDiff fDistGraph = new GFTPUsageDiff();

        DatabaseRetriever dbr = new DatabaseRetriever();

        System.out.println("<combined-gftpusagediff-report>");
