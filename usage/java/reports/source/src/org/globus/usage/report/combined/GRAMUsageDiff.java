...
public class GRAMUsageDiff extends SlotWeekHelper {
...
/*         System.out.println("<timediff ip=\"" + ipAddr + " diff=\"" + ((curDiff / 1000) / SEC_PER_WEEK) + " weeks\"/>"); */
    ...
    public static void main(String[] args) throws Exception {
        String USAGE = "Usage: java GRAMUsageDiff [options] <date (YYYY-MM-DD)> Enter -help for a list of options\n";
        ...
        GRAMUsageDiff fDistGraph = new GRAMUsageDiff();
        ...
        System.out.println("<combined-gramusagediff-report>");
