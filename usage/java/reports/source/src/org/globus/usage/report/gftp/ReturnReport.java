...
public class ReturnReport{
    ...
    public static void main (String [] args) throws Exception {
        ...
        HistogramParser transferHist = new HistogramParser("Number of Packets Shown by Transfer Type", "GFTPtransferhistogram", "Number of GFTP Packets with Given Transfer Type", n);
        
        HistogramParser responseHist = new HistogramParser("Number of Packets Shown by FTP Reponse Code", "GFTPresponsehistogram", "Number of GFTP Packets with Given Response Code", n);

        HistogramParser versionHist = new HistogramParser("Number of Packets shown by GFTP Version", "GFTPversionhistogram", "Number of Packets of Given Version", n);
        ...
        while (ts.next()){
            ...
            ResultSet rs = dbr.retrieve("gftp_packets", new String [] {"gftp_version","stor_or_retr","ftp_return_code"}, startDate, ts.getTime());
            while(rs.next()){
                versionHist.addData(rs.getString(1).substring(0,rs.getString(1).indexOf("(")), 1);
