...
#define GLOBUS_XIO_UDT_INVALID_HANDLE GLOBUS_XIO_SYSTEM_INVALID_HANDLE
...
typedef enum
{
    ...
    GLOBUS_XIO_UDT_SET_HANDLE,
     
    /**
     *  target/server attrs cntls, handle cntl
     */
    /* globus_xio_system_handle_t *     handle_out */
    GLOBUS_XIO_UDT_GET_HANDLE,          
    
    /**
     *  server attrs 
     */
    /* const char *                     service_name */
    GLOBUS_XIO_UDT_SET_SERVICE,         
    /* char **                          service_name_out */
    GLOBUS_XIO_UDT_GET_SERVICE,         
    /* int                              listener_port */
    GLOBUS_XIO_UDT_SET_PORT,            
    /* int *                            listener_port_out */
    GLOBUS_XIO_UDT_GET_PORT,            
    /* int                              listener_backlog */
    GLOBUS_XIO_UDT_SET_BACKLOG,         
    /* int *                            listener_backlog_out */
    GLOBUS_XIO_UDT_GET_BACKLOG,         
    /* int                              listener_min_port */
    /* int                              listener_max_port */
    GLOBUS_XIO_UDT_SET_LISTEN_RANGE,
    /* int *                            listener_min_port_out */
    /* int *                            listener_max_port_out */
    GLOBUS_XIO_UDT_GET_LISTEN_RANGE,
    
    /**
     *  handle/server attrs
     */
    /* const char *                     interface */
    GLOBUS_XIO_UDT_SET_INTERFACE,       
    /* char **                          interface_out */
    GLOBUS_XIO_UDT_GET_INTERFACE,
    /* globus_bool_t                    restrict_port */
    GLOBUS_XIO_UDT_SET_RESTRICT_PORT,
    /* globus_bool_t *                  restrict_port_out */
    GLOBUS_XIO_UDT_GET_RESTRICT_PORT,
    /* globus_bool_t                    resuseaddr */
    GLOBUS_XIO_UDT_SET_REUSEADDR,
    /* globus_bool_t *                  resuseaddr_out */
    GLOBUS_XIO_UDT_GET_REUSEADDR,
    ...
    GLOBUS_XIO_UDT_SET_CONNECT_RANGE,
    /* int *                            connector_min_port_out */
    /* int *                            connector_max_port_out */
    GLOBUS_XIO_UDT_GET_CONNECT_RANGE,

    /**
     *  handle attrs/cntls
     */
    /* globus_bool_t                    keepalive */
    GLOBUS_XIO_UDT_SET_KEEPALIVE,
    /* globus_bool_t *                  keepalive_out */
    GLOBUS_XIO_UDT_GET_KEEPALIVE,
    /* globus_bool_t                    linger */
    /* int                              linger_time */
    GLOBUS_XIO_UDT_SET_LINGER,
    /* globus_bool_t *                  linger_out */
    /* int *                            linger_time_out */
    GLOBUS_XIO_UDT_GET_LINGER,
    /* globus_bool_t                    oobinline */
    GLOBUS_XIO_UDT_SET_OOBINLINE,
    /* globus_bool_t *                  oobinline_out */
    GLOBUS_XIO_UDT_GET_OOBINLINE,
    /* int                              sndbuf */
    GLOBUS_XIO_UDT_SET_SNDBUF,
    /* int *                            sndbuf_out */
    GLOBUS_XIO_UDT_GET_SNDBUF,
    /* int                              rcvbuf */
    GLOBUS_XIO_UDT_SET_RCVBUF,
    /* int *                            rcvbuf_out */
    GLOBUS_XIO_UDT_GET_RCVBUF,
    /* globus_bool_t                    nodelay */
    GLOBUS_XIO_UDT_SET_NODELAY,
    /* globus_bool_t *                  nodelay_out */
    GLOBUS_XIO_UDT_GET_NODELAY,

    /**
     * data descriptors
     */
    /* int                              send_flags */
    GLOBUS_XIO_UDT_SET_SEND_FLAGS,
    /* int *                            send_flags_out */
    GLOBUS_XIO_UDT_GET_SEND_FLAGS,

    /**
     * handle/server/target cntls
     */
    /* char **                          contact_string_out */
    GLOBUS_XIO_UDT_GET_LOCAL_CONTACT,
    /* char **                          contact_string_out */
    GLOBUS_XIO_UDT_GET_LOCAL_NUMERIC_CONTACT,
    /* char **                          contact_string_out */
    GLOBUS_XIO_UDT_GET_REMOTE_CONTACT,
    /* char **                          contact_string_out */
