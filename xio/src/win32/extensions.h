...
GlobusXIODeclareModule(file); GlobusXIODeclareModule(http); GlobusXIODeclareModule(mode_e); GlobusXIODeclareModule(ordering); GlobusXIODeclareModule(queue); GlobusXIODeclareModule(tcp); GlobusXIODeclareModule(telnet); GlobusXIODeclareModule(udp); GlobusXIODeclareModule(udt); 
