...
#define GRAM_JOB_STATE_SUSPENDED           @GRAM_JOB_STATE_SUSPENDED@
#define GRAM_JOB_STATE_ALL                 @GRAM_JOB_STATE_ALL@
...
#define GRAM_ERROR_INVALID_JOBTYPE         @GRAM_ERROR_INVALID_JOBTYPE@
#define GRAM_ERROR_INVALID_MYJOB           @GRAM_ERROR_INVALID_MYJOB@
#define GRAM_ERROR_BAD_SCRIPT_ARG_FILE     @GRAM_ERROR_BAD_SCRIPT_ARG_FILE@
#define GRAM_ERROR_ARG_FILE_CREATION_FAILED @GRAM_ERROR_ARG_FILE_CREATION_FAILED@
#define GRAM_ERROR_INVALID_JOBSTATE        @GRAM_ERROR_INVALID_JOBSTATE@
#define GRAM_ERROR_INVALID_SCRIPT_REPLY    @GRAM_ERROR_INVALID_SCRIPT_REPLY@
#define GRAM_ERROR_INVALID_SCRIPT_STATUS   @GRAM_ERROR_INVALID_SCRIPT_STATUS@
#define GRAM_ERROR_MPI_NOT_SUPPORTED       @GRAM_ERROR_MPI_NOT_SUPPORTED@
#define GRAM_ERROR_UNIMPLEMENTED           @GRAM_ERROR_UNIMPLEMENTED@
#define GRAM_ERROR_TEMP_SCRIPT_FILE_FAILED @GRAM_ERROR_TEMP_SCRIPT_FILE_FAILED@
#define GRAM_ERROR_PROXY_FILE_RELOCATION_FAILED @GRAM_ERROR_PROXY_FILE_RELOCATION_FAILED@
#define GRAM_ERROR_PROXY_FILE_OPEN_FAILED @GRAM_ERROR_PROXY_FILE_OPEN_FAILED@
#define GRAM_ERROR_JOB_CANCEL_FAILED @GRAM_ERROR_JOB_CANCEL_FAILED@
/* Add new GRAM_ERROR code here */
/* don't forget to update gram_error.c also !! */
