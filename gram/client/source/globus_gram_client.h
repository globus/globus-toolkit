 ...
 */
#define GLOBUS_GRAM_CLIENT_SUCCESS \
	@GLOBUS_GRAM_CLIENT_SUCCESS@
...
#define GLOBUS_GRAM_MYJOB_SUCCESS			GLOBUS_GRAM_SUCCESS
#define GLOBUS_GRAM_MYJOB_ERROR_NOT_INITIALIZED	(GLOBUS_GRAM_MYJOB_ERROR_BASE + 0)
#define GLOBUS_GRAM_MYJOB_ERROR_BAD_PARAM		(GLOBUS_GRAM_MYJOB_ERROR_BASE + 1)
#define GLOBUS_GRAM_MYJOB_ERROR_COMM_FAILURE		(GLOBUS_GRAM_MYJOB_ERROR_BASE + 2)
#define GLOBUS_GRAM_MYJOB_ERROR_BAD_RANK		(GLOBUS_GRAM_MYJOB_ERROR_BASE + 3)
#define GLOBUS_GRAM_MYJOB_ERROR_BAD_SIZE		(GLOBUS_GRAM_MYJOB_ERROR_BASE + 4)
