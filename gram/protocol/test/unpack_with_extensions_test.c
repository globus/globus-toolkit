 ...
 *
 * PURPOSE:
 *     Check that globus_gram_protocol_unpack_status_update_message_with_extensions
...
/* Test case:
 * PURPOSE:
 *     Make sure globus_gram_protocol_unpack_status_update_message_with_extensions
...
/*
 * PURPOSE:
 *     Verify that globus_gram_protocol_unpack_status_update_message_with_extensions()
