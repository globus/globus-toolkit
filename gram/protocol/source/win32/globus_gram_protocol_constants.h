...
typedef enum
{
	...
	GLOBUS_GRAM_PROTOCOL_ERROR_AUTHZ_SYSTEM_DENIAL=162/**<  */,
	GLOBUS_GRAM_PROTOCOL_ERROR_AUTHZ_SYSTEM_FAILURE_REPORT=163/**<  */,
	GLOBUS_GRAM_PROTOCOL_ERROR_AUTHZ_SYSTEM_INVALID_JOB_ID=164/**<  */,
	GLOBUS_GRAM_PROTOCOL_ERROR_AUTHZ_SYSTEM_CANT_RUN_EXE=165/**<  */,
	GLOBUS_GRAM_PROTOCOL_ERROR_LAST=166/**<  */
}
globus_gram_protocol_error_t;

/* ToDo: 162 to 165 done manually - should they come from somewhere else? */
