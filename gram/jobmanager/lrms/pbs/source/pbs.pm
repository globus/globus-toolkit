...
my ($mpisoftenv, $mpirun, $mpiexec, $qsub, $qstat, $qdel, $cluster, $cpu_per_node, $remote_shell);
...
BEGIN
{
    ...
    $mpisoftenv = $config->get_attribute('mpisoftenv') || '0';
...
###############################################################################
# TeraGrid -- Advance reservation selection
