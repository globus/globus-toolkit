...
#		mv gt5.0.2-all-source-installer/source-trees/gsi/callback/source globus_gsi_callback-2.7
#		cp -p gt5.0.2-all-source-installer/source-trees/core/source/GLOBUS_LICENSE globus_gsi_callback-2.7
#		tar -zcf globus_gsi_callback-2.7.tar.gz globus_gsi_callback-2.7
