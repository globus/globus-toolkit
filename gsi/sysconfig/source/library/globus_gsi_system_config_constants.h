...
typedef enum
{
    ...
    GLOBUS_GSI_SYSCONFIG_ERROR_LAST = 17
...
typedef enum
{
    ...
    GLOBUS_FILE_INVALID,
    GLOBUS_FILE_DIR,
    GLOBUS_FILE_DOES_NOT_EXIST,
    GLOBUS_FILE_NOT_OWNED,
    GLOBUS_FILE_BAD_PERMISSIONS,
    GLOBUS_FILE_ZERO_LENGTH,
    GLOBUS_FILE_STATUS_LAST
