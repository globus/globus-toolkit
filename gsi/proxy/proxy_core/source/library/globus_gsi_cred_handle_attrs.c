    ...
    globus_gsi_cred_handle_attrs_t *    handle_attrs)
{
    ...
    {
        return GLOBUS_GSI_CRED_ERROR_RESULT(
            GLOBUS_GSI_CRED_ERROR_NON_NULL_HANDLE_ATTRS);
    }
     ...
     * as the default.
     */
    result = globus_gsi_cred_get_user_cert_filename(&(*handle_attrs)->cert_file,
    ...
    globus_gsi_cred_handle_attrs_t *    b)
{
    ...
    {
        return GLOBUS_GSI_CRED_ERROR_RESULT(
            GLOBUS_GSI_CRED_ERROR_NON_NULL_HANDLE);
    }
    ...
    char *                              ca_cert_dir)
{
    ...
    handle_attrs->ca_cert_dir = strdup(ca_cert_dir);
    return GLOBUS_SUCCESS;
}
/* @} */
    ...
    char **                             ca_cert_dir)
{
    ...
    *ca_cert_dir = strdup(handle_attrs->ca_cert_dir);
    return GLOBUS_SUCCESS;
}
    ...
    char *                              proxy_file)
{
    ...
    handle_attrs->proxy_file = strdup(proxy_file);
    return GLOBUS_SUCCESS;
}
/* @} */
    ...
    char **                             proxy_file)
{
    ...
    *proxy_file = strdup(handle_attrs->proxy_file);
    return GLOBUS_SUCCESS;
}
/* @} */
    ...
    char *                              cert_file)
{
    ...
    handle_attrs->cert_file = strdup(cert_file);
    return GLOBUS_SUCCESS;
}
/* @} */
    ...
    char **                             cert_file)
{
    ...
    *cert_file = strdup(handle_attrs->cert_file);
    ...
    char *                              key_file)
{
    ...
    handle_attrs->key_file = strdup(key_file);
    return GLOBUS_SUCCESS;
}
/* @} */
    ...
    char **                             key_file)
{
    ...
    *key_file = strdup(handle_attrs->key_file);
    return GLOBUS_SUCCESS;
}
/* @} */
...
globus_result_t globus_gsi_cred_handle_attrs_set_search_order(
    globus_gsi_cred_handle_attrs_t      handle_attrs,
    globus_gsi_cred_type_t              search_order[3])
{
    const char *                        _FUNCTION_NAME_ =
    ...
    handle_attrs->search_order[0] = search_order[0];
    handle_attrs->search_order[1] = search_order[1];
    handle_attrs->search_order[2] = search_order[2];
    ...
    globus_gsi_cred_type_t *            search_order[])
{
    ...
    *search_order = handle_attrs->search_order;
    return GLOBUS_SUCCESS;
}
/* @} */
