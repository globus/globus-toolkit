...
# environment data from the dependent packages.
	...
	GPT_INCLUDES="-I $GLOBUS_LOCATION/include/ \
	-I $GLOBUS_LOCATION/include/$GLOBUS_FLAVOR_NAME $GPT_CONFIG_INCLUDES"
	GPT_LIBS="$GPT_CONFIG_LIBS $GPT_CONFIG_PKG_LIBS"
	GPT_LDFLAGS=" $GPT_LDFLAGS -L$GLOBUS_LOCATION/lib"
	GPT_PGM_LINKS="$GPT_CONFIG_LIBS $GPT_CONFIG_PGM_LINKS"
	GPT_LIB_LINKS="$GPT_CONFIG_LIBS $GPT_CONFIG_LIB_LINKS"
