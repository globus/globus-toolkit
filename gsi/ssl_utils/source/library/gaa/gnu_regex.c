...
/* We need this for `gnu_regex.h', and perhaps for the Emacs include files.  */
#include <sys/types.h>
...
/* These are the command codes that appear in compiled regular
   ...
   So gnu_regex.h defines a symbol `RE_EXACTN_VALUE' to be 1; the value of
...
/* This table gives an error message for each of the error codes listed
   in gnu_regex.h.  Obviously the order here has to be same as there.  */
...
/* Roughly the maximum number of failure points on the stack.  Would be
   ...
   change it ourselves.  */
int globus_re_max_failures = 2000;
...
/* Double the size of FAIL_STACK, up to approximately `globus_re_max_failures' items.
...
#define DOUBLE_FAIL_STACK(fail_stack)					\
  ((fail_stack).size > globus_re_max_failures * MAX_FAILURE_ITEMS		\
   ? 0									\
   : ((fail_stack).stack = (fail_stack_elt_t *)				\
...
/* gaa_regex_regcomp takes a regular expression as a string and compiles it.
   ...
   It returns 0 if it succeeds, nonzero if it doesn't.  (See gnu_regex.h for
