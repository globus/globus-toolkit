...
typedef enum
{
    ...
    GLOBUS_GSI_CRED_ERROR_CREATING_ERROR_OBJ = 19,
    GLOBUS_GSI_CRED_ERROR_KEY_IS_PASS_PROTECTED = 20,
    GLOBUS_GSI_CRED_ERROR_NO_CRED_FOUND = 21,
    GLOBUS_GSI_CRED_ERROR_SUBJECT_CMP = 22,
    GLOBUS_GSI_CRED_ERROR_GETTING_SERVICE_NAME = 24,
    GLOBUS_GSI_CRED_ERROR_LAST = 24
