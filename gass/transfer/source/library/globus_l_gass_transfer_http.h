...
{
    /* Client-only states */
    GLOBUS_GASS_TRANSFER_HTTP_STATE_BEGIN,
    ...
    GLOBUS_GASS_TRANSFER_HTTP_STATE_BEGIN2,
    GLOBUS_GASS_TRANSFER_HTTP_STATE_REFERRED,
    GLOBUS_GASS_TRANSFER_HTTP_STATE_DENIED,
    GLOBUS_GASS_TRANSFER_HTTP_STATE_AUTHORIZING,
    GLOBUS_GASS_TRANSFER_HTTP_STATE_SERVER_CLOSE,
    GLOBUS_GASS_TRANSFER_HTTP_STATE_SERVER_FAIL,
