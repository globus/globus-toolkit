...
import org.globus.ogsa.impl.base.reliabletransfer.ReliableTransferImpl;
...
public class ReliableTransferFactoryImpl
    extends SecureFactoryServiceSkeleton {
    public ReliableTransferFactoryImpl() {
        super ("Reliable Transfer Factory Service");
    }

    public Object createServiceObject(CreationType creation) throws GridServiceException {
        return new ReliableTransferImpl();
    }
}
