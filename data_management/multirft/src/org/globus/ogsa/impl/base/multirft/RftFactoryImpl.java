...
public class RftFactoryImpl
    ...
    public GridServiceBase createServiceObject(ExtensibilityType creation) throws GridServiceException {
       
        RftImpl rftImpl;
        System.out.println("in RFT factory");
        try {
            if (creation != null ) {
               System.out.println("String : " + AnyHelper.getAsString(creation));
                Object obj = AnyHelper.getAsSingleObject(creation,TransferRequestElement.class);
                if(obj != null) {
                ...
                if (!(obj instanceof TransferRequestElement)) {
                    throw new GridServiceException(
                            "Invalide Service parameter type: "
                            + obj.getClass()
